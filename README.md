...
빌드된 항목은 [여기](https://github.com/nutshellbox-public/colorizer/releases/tag/v0.0.3) 에서 다운받을 수 있습니다. 윈도우용 응용프로그램은 추후 생성하겠습니다.  빌드된 앱을 실행하시면 아래와 같은 창을 보실 수 있습니다. 실행 시 오버헤드가 큰 편이라 로딩이 있을 수 있습니다.
